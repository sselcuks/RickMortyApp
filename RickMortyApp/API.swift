...
public final class GetRickQuery: GraphQLQuery {
  /// The raw GraphQL definition of this operation.
  public let operationDefinition: String =
    """
    query GetRick {
  ...
  public let operationName: String = "GetRick"
  ...
  public struct Data: GraphQLSelectionSet {
    ...
    public static var selections: [GraphQLSelection] {
      return [
        GraphQLField("characters", arguments: ["filter": ["name": "rick"], "page": 1], type: .object(Character.selections)),
      ]
    }
...
public final class GetMortyQuery: GraphQLQuery {
  /// The raw GraphQL definition of this operation.
  public let operationDefinition: String =
    """
    query GetMorty {
      characters(filter: {name: "morty"}, page: 1) {
        __typename
        info {
          __typename
          pages
  ...
  public let operationName: String = "GetMorty"
  ...
  public struct Data: GraphQLSelectionSet {
    ...
    public static var selections: [GraphQLSelection] {
      return [
        GraphQLField("characters", arguments: ["filter": ["name": "morty"], "page": 1], type: .object(Character.selections)),
      ]
    }
